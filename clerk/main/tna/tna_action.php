...
if (isset($_POST['btn_action'])) {
    if ($_POST['btn_action'] == 'addtna') {
        ...
        for ($i = 1; $i <= $esgaware; $i++) {
            ...
            if ($taskes != '' && $traininges != '') {
                $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,status,section,year,grade,department) values ('$taskes','$traininges','$otres','$targetskes','$currentskes','$gapes','$trtypees','$datetres','1','esgaware','2023','$grade','$department')";
                mysqli_query($conn, $sql);
        ...
        for ($i = 1; $i <= $selfaware; $i++) {
            ...
            if ($taskse != '' && $trainingse != '') {
                $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,status,section,year,grade,department) values ('$taskse','$trainingse','$otrse','$targetskse','$currentskse','$gapse','$trtypese','$datetrse','1','selfaware','2023','$grade','$department')";
                mysqli_query($conn, $sql);
        ...
        for ($i = 1; $i <= $leadaware; $i++) {
            ...
            if ($taskle != '' && $trainingle != '') {
                $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,status,section,year,grade,department) values ('$taskle','$trainingle','$otrle','$targetskle','$currentskle','$gaple','$trtypele','$datetrle','1','leadaware','2023','$grade','$department')";
                mysqli_query($conn, $sql);
            }
        }
        ...
        for ($i = 1; $i <= $dataaware; $i++) {
            ...
            if ($taskda != '' && $trainingda != '') {
                $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,status,section,year,grade,department) values ('$taskda','$trainingda','$otrda','$targetskda','$currentskda','$gapda','$trtypeda','$datetrda','1','dataaware','2023','$grade','$department')";
                mysqli_query($conn, $sql);
        ...
        for ($i = 1; $i <= $functional; $i++) {
            ...
            if ($taskfu != '' && $trainingfu != '') {
                $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,status,section,year,grade,department) values ('$taskfu','$trainingfu','$otrfu','$targetskfu','$currentskfu','$gapfu','$trtypefu','$datetrfu','1','functional','2023','$grade','$department')";
                mysqli_query($conn, $sql);
            }
        }
        ...
        for ($i = 1; $i <= $busiaware; $i++) {
            ...
            if ($taskbu != '' && $trainingbu != '') {
                $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,status,section,year,grade,department) values ('$taskbu','$trainingbu','$otrbu','$targetskbu','$currentskbu','$gapbu','$trtypebu','$datetrbu','1','busiaware','2023','$grade','$department')";
                mysqli_query($conn, $sql);
            }
        }
        ...
        for ($i = 1; $i <= $special; $i++) {
            ...
            if (isset($_POST['currentsksp' . $i])) {
                $currentsksp = strtoupper($_POST['currentsksp' . $i]);
            }
            ...
            if ($tasksp != '' && $trainingsp != '') {
                $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,status,section,year,grade,department) values ('$tasksp','$trainingsp','$otrsp','$targetsksp','$currentsksp','$gapsp','$trtypesp','$datetrsp','1','special','2023','$grade','$department')";
                mysqli_query($conn, $sql);
            }
        }
