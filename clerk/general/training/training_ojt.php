                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-4" align="right">
                                    <div class="col-md-9">
                                        <button type="button" name="importojt" id="importojt" data-toggle="modal"
                                            data-target="#excelupload" class="btn btn-success btn-xm"><i
                                                class="fa fa-plus"></i> Import Excel</button>
                                    </div>
                                    <div class="col-md-3">
                                        <button type="button" name="addojt" id="addojt" class="btn btn-success btn-md"><i
                                                class="fa fa-plus"></i> Add OJT</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <form id="upload_csv" align="center" class="form-horizontal" method="post"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="submit" name="action" id="action"
                                                class="btn btn-success btn-block btn-xm" value="UPLOAD OJT">
                                        </div>
                                    </div>
                                    <div class="col-md-3"></div>
                                </form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-info btn-xm" data-dismiss="modal"><i class="fa fa-times"></i>
                            Close</button>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="col-md-12" style="margin-bottom:15px;">
            <div class="row">
                ...
                <!-- JUST FOR DEBUG ONLY  -->
                <!-- <div id="debug_output" style="margin-top:20px; color:red;"></div> -->
