<?php 
    ...
    if (isset($_POST['btn_action'])) {
        if ($_POST['btn_action'] == 'editattendance') {
            ...
            $ans11 = $_POST['ans11'];
            $ans12 = $_POST['ans12'];
            $ans13 = strtoupper(str_replace("'","''",$_POST['ans13']));
            $ans14 = strtoupper(str_replace("'","''",$_POST['ans14']));
            $ans15 = strtoupper(str_replace("'","''",$_POST['ans15']));
            $ans16 = strtoupper(str_replace("'","''",$_POST['ans16']));
            ...
            $trainer = '';
            $userid = $_POST['userid'];
            $title = strtoupper(str_replace("'","''",$_POST['titleojt']));
            $startdate = $_POST['startdate'];
            $enddate = $_POST['enddate'];
            $starttime = $_POST['starttime'];
            $endtime = $_POST['endtime'];
            $venue = strtoupper(str_replace("'","''",$_POST['venue']));
            $trainertype = $_POST['trainertype'];
            $externalname = strtoupper(str_replace("'","''",$_POST['externalname']));
            $internalname = $_POST['internalstaff'];
            $ans1 = strtoupper(str_replace("'","''",$_POST['que1']));
            $ans2 = $_POST['que2'];
            $ans3 = $_POST['que3'];
