                            ...
                            <form method="post" id="tna_form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10" align="left">
                                        In this TNA employee needs to complete it in consultation with your IMMEDIATE
                                        SUPERIOR. Employee is encourage to reflect on what skills you will need to succeed
                                        in the current job scope and what skills you still lack and wish to achieve or
                                        improve.
                                    </div>
                                    <div class="col-sm-1"></div>
                                </div>
                                            ...
                                            <thead>
                                                <tr>
                                                    <th colspan="9">
                                                        <div class="row">
                                                            <div class="col-sm-10" align="left" style="margin-top:5px;">
                                                                b. Soft Skills (Based on individual development competencies
                                                                i.e, communication)
                                                            </div>
                                                            <div class="col-sm-2" align="right">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group" align="right">
                                            ...
                                            <button type="submit" name="action" id="action" class="btn btn-success btn-xm"
                                                style="width: 100px;"><i class="fa fa-save"></i> Save</button>
                                        </div>
                                    </div>
                                    <div class="col-md-1"></div>
                                </div>
                    ...
                    <td>
                        <select name="trainingse${countself}" id="trainingse${countself}" class="form-control" required>
                            <option selected disabled value="">-- Select Training --</option>
                                ...
                                <option value="GREEN TECHNOLOGY AND ENERGY EFFICIENCY">GREEN TECHNOLOGY AND ENERGY EFFICIENCY</option>
                                <option value="ANTI BRRIBERY & ANTI CORRUPTION">ANTI BRRIBERY & ANTI CORRUPTION</option>
                                zz<option value="OTHERS">OTHERS</option>
                        </select>
                        <br>
