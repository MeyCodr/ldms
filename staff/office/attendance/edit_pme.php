				...
				<div class="col-md-12">
					...
					<div class="form-container">
						<form id="formSubmit" action="update_pme.php" method="post">
							...
							<!-- Behavioral Section -->
							<div class="section-title">Behavioral Change<span class="required-star">*</span></div>
							<h4>3. Did the employee apply his / her newly acquired skills and knowledge to his / her jobs ?</h4>
							<div class="form-group rating-container">
								<?php 
								$options = [
							...
							<!-- Result Section -->
							<div class="section-title">Result Training Attended<span class="required-star">*</span></div>
							<h4>4. Did the training has any measurable business impact ?</h4>
							<div class="form-group rating-container">
								<?php 
								$options = [
