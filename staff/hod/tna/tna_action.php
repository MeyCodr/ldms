        ...
        if ($_POST['btn_action'] == 'addtna') {
            ...
            for ($i=1;$i<=$selfaware;$i++) {
                ...
                if (isset($_POST['otrse'.$i])) {
                    $otrse = strtoupper(str_replace("'","''",$_POST['otrse'.$i]));
                }
            ...
            for ($i=1;$i<=$leadaware;$i++) {
                ...
                if (isset($_POST['otrle'.$i])) {
                    $otrle = strtoupper(str_replace("'","''",$_POST['otrle'.$i]));
                }
            ...
            for ($i=1;$i<=$dataaware;$i++) {
                ...
                if ($taskda != '' && $trainingda != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,userid,status,dateapprove) values ('$taskda','$trainingda','$otrda','$targetskda','$currentskda','$gapda','$trtypeda','$datetrda','dataaware','2023','$userid','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
            ...
            for ($i=1;$i<=$functional;$i++) {
                ...
                if (isset($_POST['otrfu'.$i])) {
                    $otrfu = strtoupper(str_replace("'","''",$_POST['otrfu'.$i]));
                }
            ...
            for ($i=1;$i<=$busiaware;$i++) {
                ...
                if (isset($_POST['otrbu'.$i])) {
                    $otrbu = strtoupper(str_replace("'","''",$_POST['otrbu'.$i]));
                }
            ...
            for ($i=1;$i<=$special;$i++) {
                ...
                if (isset($_POST['otrsp'.$i])) {
                    $otrsp = strtoupper(str_replace("'","''",$_POST['otrsp'.$i]));
                }
            ...
            $sql = "delete from tna where grade = '$grade' and department = '$department' and year = '2023';";
            mysqli_query($conn, $sql);
            ...
            for ($i=1;$i<=$esgaware;$i++) {
                ...
                if ($taskes != '' && $traininges != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,grade,department,status,dateapprove) values ('$taskes','$traininges','$otres','$targetskes','$currentskes','$gapes','$trtypees','$datetres','esgaware','2023','$grade','$department','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
            ...
            for ($i=1;$i<=$selfaware;$i++) {
                ...
                if ($taskse != '' && $trainingse != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,grade,department,status,dateapprove) values ('$taskse','$trainingse','$otrse','$targetskse','$currentskse','$gapse','$trtypese','$datetrse','selfaware','2023','$grade','$department','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
            ...
            for ($i=1;$i<=$leadaware;$i++) {
                ...
                if ($taskle != '' && $trainingle != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,grade,department,status,dateapprove) values ('$taskle','$trainingle','$otrle','$targetskle','$currentskle','$gaple','$trtypele','$datetrle','leadaware','2023','$grade','$department','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
                }
            }
            ...
            for ($i=1;$i<=$dataaware;$i++) {
                ...
                if (isset($_POST['currentsksda'.$i])) {
                    $currentsksda = strtoupper($_POST['currentsksda'.$i]);
                }
                ...
                if ($taskda != '' && $trainingda != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,grade,department,status,dateapprove) values ('$taskda','$trainingda','$otrda','$targetskda','$currentskda','$gapda','$trtypeda','$datetrda','dataaware','2023','$grade','$department','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
            ...
            for ($i=1;$i<=$functional;$i++) {
                ...
                if ($taskfu != '' && $trainingfu != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,grade,department,status,dateapprove) values ('$taskfu','$trainingfu','$otrfu','$targetskfu','$currentskfu','$gapfu','$trtypefu','$datetrfu','functional','2023','$grade','$department','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
                }
            }
            ...
            for ($i=1;$i<=$busiaware;$i++) {
                ...
                if ($taskbu != '' && $trainingbu != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,grade,department,status,dateapprove) values ('$taskbu','$trainingbu','$otrbu','$targetskbu','$currentskbu','$gapbu','$trtypebu','$datetrbu','busiaware','2023','$grade','$department','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
                }
            }
            ...
            for ($i=1;$i<=$special;$i++) {
                ...
                if ($tasksp != '' && $trainingsp != '') {
                    $sql = "insert into tna (task,training,othertr,targetskill,currentskill,gap,trainingtype,monthapply,section,year,grade,department,status,dateapprove) values ('$tasksp','$trainingsp','$otrsp','$targetsksp','$currentskbu','$gapsp','$trtypesp','$datetrsp','special','2023','$grade','$department','APPROVE',curdate())";
                    mysqli_query($conn, $sql);
                }
            }
