                        ...
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-md-12" style="margin-top:10px" align="center">
                                    <strong id="title">Training Need Identification (TNI) Form - (FY 2026)</strong>
                                </div>
                            </div>
                        </div>
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                if (tni == 0) {
                    ...
                    $("#tnilist").append('<tr><td style="text-align:center;">'+countmand+'</td><td><input type="text" name="task'+countmand+'" id="task'+countmand+'" class="form-control" placeholder="Insert Training" /></td><td><select name="targetsk'+countmand+'" id="targetsk'+countmand+'" class="form-control"><option value="1">1 - Fundamental Awareness</option><option value="2">2 - Novice</option><option value="3">3 - Intermediate</option><option value="4">4 - Proficient</option><option value="5">5 - Expert</option></select></td><td><select name="currentsk'+countmand+'" id="currentsk'+countmand+'" class="form-control"><option value="1">1 - Fundamental Awareness</option><option value="2">2 - Novice</option><option value="3">3 - Intermediate</option><option value="4">4 - Proficient</option><option value="5">5 - Expert</option></select></td><td style="text-align:center;"><input type="text" name="gap'+countmand+'" id="gap'+countmand+'" class="form-control" readonly /></td><td><input type="text" name="cause'+countmand+'" id="cause'+countmand+'" class="form-control" placeholder="Insert Cause" /></td><td><input type="text" name="ask'+countmand+'" id="ask'+countmand+'" class="form-control" placeholder="Insert A/S/K" /></td><td><select name="trtype'+countmand+'" id="trtype'+countmand+'" class="form-control"><option selected disabled="disabled">-- Select L&D Method --</option><option value="1">1 - On Job Training</option><option value="2">2 - Coaching</option><option value="3">3 - External / In-house</option></select></td><td><input type="text" name="evaluate'+countmand+'" id="evaluate'+countmand+'" class="form-control" placeholder="Insert Evaluation Method" /></td><td><button type="button" id="removebtn'+countmand+'" class="btn btn-danger"><i class="fa fa-trash"></i></button></td></tr>');
                    ...
                    $.ajax({
                        ...
                        success:function(data) {
                            ...
                            $.each(data, function (i, data) {
                                trHTML += '<tr><td style="text-align:center;">'+noid+'</td><td><input type="text" name="task'+noid+'" id="task'+noid+'" class="form-control" value="'+data.training+'" /></td><td><select name="targetsk'+noid+'" id="targetsk'+noid+'" class="form-control"><option value="1">1 - Fundamental Awareness</option><option value="2">2 - Novice</option><option value="3">3 - Intermediate</option><option value="4">4 - Proficient</option><option value="5">5 - Expert</option></select></td><td><select name="currentsk'+noid+'" id="currentsk'+noid+'" class="form-control"><option value="1">1 - Fundamental Awareness</option><option value="2">2 - Novice</option><option value="3">3 - Intermediate</option><option value="4">4 - Proficient</option><option value="5">5 - Expert</option></select></td><td style="text-align:center;"><input type="text" name="gap'+noid+'" id="gap'+noid+'" class="form-control" value="'+data.gap+'" readonly /></td><td><input type="text" name="cause'+noid+'" id="cause'+noid+'" class="form-control" value="'+data.cause+'" /></td><td><input type="text" name="ask'+noid+'" id="ask'+noid+'" class="form-control" value="'+data.ask+'" /></td><td><select name="trtype'+noid+'" id="trtype'+noid+'" class="form-control"><option selected disabled="disabled">-- Select Training Type --</option><option value="1">1 - On Job Training</option><option value="2">2 - Coaching</option><option value="3">3 - External / In-house</option></select></td><td><input type="text" name="evaluate'+noid+'" id="evaluate'+noid+'" class="form-control" value="'+data.evaluation+'" /></td><td><button type="button" id="removebtn'+noid+'" class="btn btn-danger"><i class="fa fa-trash"></i></button></td></tr>';
