...
var userdepartment = '<?php echo $_SESSION['department']?>';

var useridview = <?php echo $_SESSION['id']?>;
...
if (userid != useridview && usertype == 'HOD' && dept == userdepartment) {
    $('#add_esg').show();
    $('#add_self').show();
    $('#add_lead').show();
    $('#add_driven').show();
    ...
    $('#add_spec').show();
    $('#action').show();
    $('#btn_action').val('approvetna');
} else if (userid == useridview) {
    $('#add_esg').show();
    $('#add_self').show();
    $('#add_lead').show();
    $('#add_driven').show();
...
$.ajax({
    ...
    success: function(data) {
        ...
        if (tna == 0) {
            console.log("No TNA found for this user.");
            $('#btn_action').val('addtna');
            $('#userid').val(userid);
        } else if (tna > 0) {
            if (data[0].status == "") {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function(data) {
                    console.log("esg data here" ,data);
                    var trHTMLes = '';
                    var trHTMLse = '';
                    var trHTMLle = '';
                    var trHTMLda = '';
...
d                                                                <option value="OTHERS">OTHERS</option>
                    ...
                    if (userid != useridview && usertype == 'HOD') {
                        $('.remove_esg').show();
                        $('.remove_self').show();
                        $('.remove_lead').show();
                        $('.remove_driven').show();
...
$(document).on('submit', '#tna_form', function(event) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            } else if ((response.message) == 'insertapp') {
                swal(
                    'Approved!',
                    'The TNA has been approved.',
                    'success'
                ).then(function() {
                    window.location = "manage_tna.php";
                })
