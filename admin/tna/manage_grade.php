...
if (isset($_SESSION['fullname']) && ($_SESSION['role'] == 'ADMIN')) {
                            ...
                            <form method="post" id="tna_form">
                                <!-- <div class="row">
                                    ...
                                    <div class="col-sm-10" align="left">
                                        <button type="button" name="print_pdf" id="print_pdf" class="btn btn-info btn-sm">Print PDF <i class="fa fa plus"></i> </button>
                                    </div>
                                    <div class="col-sm-1"></div>
                                </div>
                                <br> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group" align="right">
                                            ...
                                            <!-- <button type="submit" name="action" id="action" class="btn btn-success btn-xm" style="width: 150px;"><i class="fa fa-save"></i> Save & Approve</button> -->
                                        </div>
                                    </div>
                                    <div class="col-md-1"></div>
                                </div>
    ...
    <script>
        ...
        var dept = localStorage.getItem("setdept");
        console.log("dept: ", dept);

        $('#back_training').click(function () {
            sessionStorage.setItem("setdeptnext", dept);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (tna == 0) {
                    ...
                    console.log("action1 here: ", action1);
                    $.ajax({
                        url: "fetch_tna.php",
                        method: "POST",
                        data: {
...
d                                                                <option value="OTHERS">OTHERS</option>
                            ...
                            $('#removebtnse' + countself).click(function () {
                                countself--;
                                $('#tnaselflist tr:last').remove();
                                if (countself != 1) {
                                    $('#removebtnse' + countself).show();
                                }
                            ...
                            $('#removebtnle' + countlead).click(function () {
                                countlead--;
                                $('#tnaleadlist tr:last').remove();
                                if (countlead != 1) {
                                    $('#removebtnle' + countlead).show();
                                }
                            ...
                            $('#removebtnfu' + countfunc).click(function () {
                                countfunc--;
                                $('#tnafunclist tr:last').remove();
                                if (countfunc != 1) {
                                    $('#removebtnfu' + countfunc).show();
                                }
                            ...
                            $('#removebtnbu' + countbusi).click(function () {
                                countbusi--;
                                $('#tnabusilist tr:last').remove();
                                if (countbusi != 1) {
                                    $('#removebtnbu' + countbusi).show();
                                }
                            ...
                            $('#removebtnsp' + countspec).click(function () {
                                countspec--;
                                $('#tnaspeclist tr:last').remove();
                                if (countspec != 1) {
                                    $('#removebtnsp' + countspec).show();
                                }
            ...
            if (countlead == 1) {
                $("#tnaleadlist").append(`
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" name="taskle${countlead}" id="taskle${countlead}" rows="2" placeholder="Insert your problem statement" required></textarea>
                        </td>
                        <td>
            ...
            if (countdriven == 1) {
                $("#tnadrivenlist").append(`
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" name="taskda${countdriven}" id="taskda${countdriven}" rows="2" placeholder="Insert your problem statement" required></textarea>
                        </td>
                        <td>
        ...
        $('#add_func').click(function () {
            ...
            if (countfunc == 1) {
                ...
                <tr>
                    ...
                    <td>
                        <textarea class="form-control" name="taskfu${countfunc}" id="taskfu${countfunc}" rows="2" placeholder="Insert your problem statement" required></textarea>
                    </td>
                    <td>
            ...
            if (countbusi == 1) {
                $("#tnabusilist").append(`
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" name="taskbu${countbusi}" id="taskbu${countbusi}" rows="2" placeholder="Insert your problem statement" required></textarea>
                        </td>
                        <td>
