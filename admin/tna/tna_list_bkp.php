...
<html lang="en">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2" align="left">
                                            <button type="button" name="filter_dept" id="filter_dept" class="btn btn-info btn-md">FILTER <i class="fa fa-search"></i> </button>
                                        </div>
                                        <div class="col-md-4" align="right">
                                            <div class="row">
                                                <form action="export_tnaall.php" align= "center" class="form-horizontal"  method="post" enctype="multipart/form-data">
                                                    <div class="col-md-12">
                                                        <input type="hidden" name="departmentrep" id="departmentrep" />
                                                        <button type="submit" name="export_tna" id="export_tna" class="btn btn-success btn-xm" style="width: 150px;"><i class="fas fa-file-pdf"> </i> TNA SUMMARY</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(function(){
            $.post("fetch_tna.php",{action:"load_department"},function(data){
        ...
        function fetch_data(action,userid,department){
            var userdataTable = $('#userlist').DataTable({
                ...
                "ajax":{
                    ...
                    type:"POST",
                    dataSrc: '',
                    data : {action:action,userid:userid,department:department},
                },
                "columns": [
                    {
                        "data": "id",
