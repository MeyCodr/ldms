                                ...
                                <div class="col-xs-12 col-sm-6 dash-card-col" id="cardColTotalUser">
                                    <div class="dash-card-box" style="background-color: #FF0000;border-radius: 5px;">
                                        <div class="panel-body" align="center">
                                            ...
                                            <div class="col-sm-8" align="left">
                                                <p class="dash-card-label" style="color:white;margin-top:7px;" align="right"><span id="totalUserLabel">Total Participant Attend Training</span>
                                                </p>
                                  ...
                                  <div class="col-xs-12 col-sm-6 dash-card-col" id="cardColTotalManpower">
                                    <div class="dash-card-box" style="background-color: #8E44AD;border-radius: 5px;">
                                        <div class="panel-body" align="center">
                                            ...
                                            <div class="col-sm-8" align="left">
                                                <p class="dash-card-label" style="color:white;margin-top:7px;" align="right">Total Manpower
                                                </p>
                                        ...
                                        <div class="panel-body" align="center">
                                            <div class="col-sm-4">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60"
                                                    ...
                                                    style="color:white;">
                                                    <path
                                                        d="M4 16s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H4Zm4.5-9a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
                                                    <path
                                                        d="M13 1a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H6.71c.907.451 1.63 1.226 2.02 2H13a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H3a2 2 0 0 0-2 2v3.5a1 1 0 0 0 1 0V2a1 1 0 0 1 1-1h10Z" />
                                                </svg>
                                            </div>
                                            <div class="col-sm-8" align="left">
