...
<html lang="en">
        ...
        <div class="container-fluid">
			...
			<div class="row">
                <div class="col-md-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Culture & Talent Management Department</strong>
                        </div>
                        <div class="panel-body" align="center">
							<div class="row">
								<div class="col-md-12">
									<canvas id="cultureChart" style="width:100%;max-width:700px"></canvas>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-md-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Human Capital & Admin Department</strong>
                        </div>
                        <div class="panel-body" align="center">
							<div class="row">
								<div class="col-md-12">
    ...
    <script>
		...
		makehumanchart(modeprev,fd,ld);

		var canvasCulture = document.getElementById("cultureChart");
		var cultureChart;

		function makeculturechart(mode,startdate,enddate) {
			$.ajax({
				url:"fetch_human.php",
				method:"POST",
				data:{action:'fetch_culture',mode:mode,startdate:startdate,enddate:enddate},
				dataType:"JSON",
				success:function(data)
				{
                    var ctxCulture = canvasCulture.getContext('2d');
                    var category = [];
					var totalsend = [];
					var colorplant = [];
                    ...
                    cultureChart = new Chart(ctxCulture, {
                        type: 'bar',
                        data: {
                            labels: category,
                            datasets: [
		...
		function destroyChartCulture() {
            cultureChart.destroy();
        }

		makeculturechart(modeprev,fd,ld);
		...
		$('#filter_date').click(function(){
			...
			destroyChartCulture();
			makeculturechart(mode,startdate,enddate);
        });
        ...
        $('#clear_filter').click(function(){
			...
			destroyChartCulture();
			makeculturechart('manhour',fd,ld);
            $('#startdate').val('');
            $('#enddate').val('');
			$('#mode').val('manhour');
        });
