...
<html lang="en">
        ...
        <div class="container-fluid">
			...
			<div class="row">
                <div class="col-md-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Business Development Department</strong>
                        </div>
                        <div class="panel-body" align="center">
							<div class="row">
								<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Program Management 1 Department</strong>
                        </div>
                        <div class="panel-body" align="center">
							<div class="row">
								<div class="col-md-12">
									<canvas id="pm1Chart" style="width:100%;max-width:700px"></canvas>
								</div>
							</div>
						</div>
					</div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Program Management 2 Department</strong>
                        </div>
                        <div class="panel-body" align="center">
                            <div class="row">
                                <div class="col-md-12">
                                    <canvas id="pm2Chart" style="width:100%;max-width:700px"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Quality Development Department</strong>
                        </div>
                        <div class="panel-body" align="center">
                            <div class="row">
                                <div class="col-md-12">
                                    <canvas id="qdChart" style="width:100%;max-width:700px"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
		...
		makebusinesschart(modeprev,fd,ld);

		var canvasPm1 = document.getElementById("pm1Chart");
		var pm1Chart;

		function makepm1chart(mode,startdate,enddate) {
			$.ajax({
				url:"fetch_business.php",
				method:"POST",
				data:{action:'fetch_pm1',mode:mode,startdate:startdate,enddate:enddate},
				dataType:"JSON",
				success:function(data)
				{
                    var ctxPm1 = canvasPm1.getContext('2d');
                    var category = [];
					var totalsend = [];
					var colorplant = [];
		...
		function destroyChartPm1() {
            pm1Chart.destroy();
        }

		makepm1chart(modeprev,fd,ld);

        var canvasPm2 = document.getElementById("pm2Chart");
		var pm2Chart;

		function makepm2chart(mode,startdate,enddate) {
			$.ajax({
				url:"fetch_business.php",
				method:"POST",
				data:{action:'fetch_pm2',mode:mode,startdate:startdate,enddate:enddate},
				dataType:"JSON",
				success:function(data)
				{
                    var ctxPm2 = canvasPm2.getContext('2d');
                    var category = [];
					var totalsend = [];
					var colorplant = [];
		...
		function destroyChartPm2() {
            pm2Chart.destroy();
        }

		makepm2chart(modeprev,fd,ld);

		var canvasQd = document.getElementById("qdChart");
		var qdChart;

		function makeqdchart(mode,startdate,enddate) {
			$.ajax({
				url:"fetch_business.php",
				method:"POST",
				data:{action:'fetch_qd',mode:mode,startdate:startdate,enddate:enddate},
				dataType:"JSON",
				success:function(data)
				{
                    var ctxQd = canvasQd.getContext('2d');
                    var category = [];
					var totalsend = [];
					var colorplant = [];
		...
		function destroyChartQd() {
            qdChart.destroy();
        }

		makeqdchart(modeprev,fd,ld);
		...
		$('#filter_date').click(function(){
			...
			destroyChartPm1();
			makepm1chart(mode,startdate,enddate);
            destroyChartPm2();
			makepm2chart(mode,startdate,enddate);
			destroyChartQd();
			makeqdchart(mode,startdate,enddate);
        });
        ...
        $('#clear_filter').click(function(){
			...
			destroyChartPm1();
			makepm1chart('manhour',fd,ld);
            destroyChartPm2();
			makepm2chart('manhour',fd,ld);
			destroyChartQd();
			makeqdchart('manhour',fd,ld);
            $('#startdate').val('');
            $('#enddate').val('');
			$('#mode').val('manhour');
        });
